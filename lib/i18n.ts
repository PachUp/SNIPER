...
const en: Dict = {
  ...
  "news.holdingNone":
    "No headlines naming your holdings right now. Check back after the next market move.",
  "news.mayAffect": "Your holding",
  "news.yourHolding": "Your holding",
  "news.whyHolding": "named in this story",
  "news.whyIndustry": "same industry",
  "news.whySector": "same sector",
  "news.subtitle":
    "Full one-sentence headlines — green good, red bad. Tap for why it matters and the full story.",
  "filter.all": "All",
  "filter.good": "Good",
  "filter.bad": "Bad",
  "newsline.good": "GOOD",
  "newsline.bad": "BAD",
  "newsline.details": "Why it matters →",
  "popup.companies": "Story names:",
  "popup.edge": "Why it matters for your holding",
